...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[4] = LAYOUT_split_3x5_3(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LCTL(KC_C), KC_HOME, KC_UP, KC_END, KC_PGUP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LCTL(KC_V), KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LCTL(KC_X), LCTL(KC_A), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RSFT(KC_PSCR), RCS(KC_PSCR), KC_TRNS),
	[5] = LAYOUT_split_3x5_3(LGUI(KC_SPC), KC_BTN2, KC_MS_U, KC_BTN1, KC_WH_U, LCTL(KC_C), KC_HOME, KC_UP, KC_END, KC_PGUP, KC_CAPS, KC_MS_L, KC_MS_D, KC_MS_R, KC_BTN3, LCTL(KC_V), KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_TRNS, KC_ACL0, KC_ACL1, KC_ACL2, KC_WH_D, LCTL(KC_X), LCTL(KC_A), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RCS(KC_PSCR), RSFT(KC_PSCR), KC_TRNS),
